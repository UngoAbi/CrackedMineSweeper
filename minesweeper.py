...
img_mine_flag_icon = pygame.image.load('assets/mine_flag.png')
img_mine_flag = pygame.transform.scale(img_mine_flag_icon, (CELL_WIDTH, CELL_HEIGHT)).convert_alpha()
img_hidden_cell = pygame.transform.scale(pygame.image.load('assets/hidden_cell.png'), (CELL_WIDTH, CELL_HEIGHT)).convert()
img_mine = pygame.transform.scale(pygame.image.load('assets/mine.png'), (CELL_WIDTH, CELL_HEIGHT)).convert_alpha()
img_nums = [pygame.transform.scale(pygame.image.load(f'CrackedMineSweeper/assets/num_{i + 1}.png'), (CELL_WIDTH, CELL_HEIGHT)).convert_alpha() for i in range(8)]

snd_mine = pygame.mixer.Sound('assets/explosion.mp3')
snd_win = pygame.mixer.Sound('assets/win.mp3')
